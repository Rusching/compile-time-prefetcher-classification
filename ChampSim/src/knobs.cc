...
int parse_knobs(void *user, const char *section, const char *name,
                const char *value)
{
    char config_file_name[MAX_LEN];
    ...
    {
        knob::next_line_enable_prefetch_tracking =
    ...
    {
        knob::sandbox_enable_stream_detect =
            !strcmp(value, "true") ? true : false;
    }
    ...
    else if (MATCH("", "dspatch_log2_region_size"))
    {
        ...
        knob::dspatch_num_cachelines_in_region =
            1 << (knob::dspatch_log2_region_size -
                  6); /* considers traditional 64B cachelines */
    }
    ...
    {
        knob::dspatch_enable_pref_buffer =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::scooby_enable_track_multiple =
            !strcmp(value, "true") ? true : false;
    }
    else if (MATCH("", "scooby_enable_reward_out_of_bounds"))
    {
        knob::scooby_enable_reward_out_of_bounds =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::scooby_enable_state_action_stats =
            !strcmp(value, "true") ? true : false;
    }
    else if (MATCH("", "scooby_enable_reward_tracker_hit"))
    {
        knob::scooby_enable_reward_tracker_hit =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::scooby_prefetch_with_shaggy =
            !strcmp(value, "true") ? true : false;
    }
    else if (MATCH("", "scooby_enable_featurewise_engine"))
    {
        knob::scooby_enable_featurewise_engine =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::scooby_last_pref_offset_conf_thresholds_hbw =
            get_array_int(value);
    }
    ...
    {
        knob::le_featurewise_enable_action_fallback =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::le_featurewise_enable_dynamic_weight =
            !strcmp(value, "true") ? true : false;
    }
    else if (MATCH("", "le_featurewise_weight_gradient"))
    {
        knob::le_featurewise_weight_gradient = atof(value);
                   ...
                   "le_featurewise_disable_adjust_weight_all_features_align"))
    {
        knob::le_featurewise_disable_adjust_weight_all_features_align =
            !strcmp(value, "true") ? true : false;
    }
    else if (MATCH("", "le_featurewise_selective_update"))
    {
        knob::le_featurewise_selective_update =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::le_featurewise_enable_dyn_action_fallback =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::le_featurewise_enable_trace =
            !strcmp(value, "true") ? true : false;
    }
    ...
    {
        knob::le_featurewise_enable_score_plot =
            !strcmp(value, "true") ? true : false;
    }
    ...
    else if (MATCH("", "pf_min_confidence"))
    {
        knob::pf_min_confidence = atoi(value);
    }
    ...
    {
        knob::pf_timestamps = atoi(value);
    }
    else if (MATCH("", "pf_input_intensity"))
    {
        knob::pf_input_intensity = atoi(value);
    }
